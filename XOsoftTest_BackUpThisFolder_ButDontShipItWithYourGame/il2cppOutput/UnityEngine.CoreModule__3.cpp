...
{
	{
		...
		CommandBuffer_ClearRenderTarget_m86BF9DA24C5329F4AC1F28F4658E00454A82E86C(__this, L_0, L_1, L_2, (1.0f), 0, NULL);
		return;
	}
}
...
IL_0019:
	{
		...
		float L_4 = ___3_depth;
		uint32_t L_5 = ___4_stencil;
		NullCheck(G_B6_2);
		CommandBuffer_ClearRenderTargetSingle_Internal_m723F250018F9E457F21067C94856CD7D2347004E(G_B6_2, ((int32_t)(G_B6_1|G_B6_0)), L_3, L_4, L_5, NULL);
		return;
	}
}
